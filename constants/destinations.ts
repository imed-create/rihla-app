...
export const DESTINATIONS: Destination[] = [
  ...
  },
  {
    ...
    name: 'Ghazaouet',
    region: 'Tlemcen',
    tagline: 'Emerald Mediterranean coves on Algeria\'s western coast',
    gradient: ['#00B4D8', '#0a2540'],
    rating: 4.8,
    reviews: 512,
    distance: '620 km',
    flag: 'green',
    features: ['Crystal Cove', 'Fresh Seafood', 'Sunset Views'],
    services: ['parking', 'spots', 'food', 'clothes', 'games', 'activities', 'massage', 'hotels', 'showers', 'events', 'powerbank', 'photos', 'guide'],
    lat: 35.0969,
    lng: -2.9333,
  },
