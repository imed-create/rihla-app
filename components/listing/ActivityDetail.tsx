...
const styles = StyleSheet.create({
  ...
  slotList: { gap: 8 },
  slotCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: RIHLA.border, padding: 14 },
  slotFull: { opacity: 0.5 },
  slotSelected: { borderColor: RIHLA.accent, backgroundColor: '#F0FDFA' },
  slotLeft: { flex: 1 },
  slotDate: { fontSize: 13, fontFamily: 'mon-b', color: RIHLA.dark },
