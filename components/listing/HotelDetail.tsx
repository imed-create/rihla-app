    ...
    <View style={[styles.root, { backgroundColor: RIHLA.background }]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: insets.bottom + 120 }}>
        ...
        <View style={[styles.heroWrap, { paddingTop: topPad }]}>
          <LinearGradient colors={['#1A6B3A', RIHLA.primary]} style={styles.hero}>
        ...
        <View style={styles.section}>
          ...
          {m.breakfast_included && (
            <View style={styles.breakfastPill}>
              <Ionicons name="cafe-outline" size={14} color={RIHLA.accent} />
...
const styles = StyleSheet.create({
  ...
  amenityPill: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10, backgroundColor: '#fff', borderWidth: 1, borderColor: RIHLA.border },
  ...
  // Check-in/out
  checkRow: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 14, borderWidth: 1, borderColor: RIHLA.border, padding: 16 },
  checkCol: { flex: 1, alignItems: 'center', gap: 4 },
  checkLabel: { fontSize: 11, fontFamily: 'mon-sb', color: '#94A3B8', letterSpacing: 1 },
  checkTime: { fontSize: 20, fontFamily: 'mon-b', color: RIHLA.dark },
  checkDivider: { width: 1, backgroundColor: RIHLA.border, marginVertical: -4 },
  ...
  breakfastText: { fontSize: 12, fontFamily: 'mon-sb', color: RIHLA.accent },

  // Calendar
  calendarRow: { flexDirection: 'row', gap: 6, paddingHorizontal: 4 },
  dayCell: {
    width: 60, height: 72, borderRadius: 12, borderWidth: 1, borderColor: RIHLA.border,
  ...
  dateHint: { fontSize: 13, fontFamily: 'mon', color: RIHLA.accent, marginTop: 8 },
  dateSelected: { fontSize: 13, fontFamily: 'mon-sb', color: RIHLA.primary, marginTop: 8 },

  // Rooms
  roomList: { gap: 10 },
  roomCard: {
    backgroundColor: '#fff', borderRadius: 14, borderWidth: 1.5, borderColor: RIHLA.border, padding: 16, position: 'relative',
  },
  ...
  reviewCard: { flexDirection: 'row', gap: 12, backgroundColor: '#fff', borderRadius: 14, borderWidth: 1, borderColor: RIHLA.border, padding: 14, marginTop: 8 },
  reviewAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: RIHLA.primary, alignItems: 'center', justifyContent: 'center' },
  ...
  bookBtn: {
    backgroundColor: RIHLA.primary, paddingHorizontal: 28, paddingVertical: 16, borderRadius: 14,
    shadowColor: RIHLA.primary, shadowOpacity: 0.3, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 6,
  },
