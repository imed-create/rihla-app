...
const menuStyles = StyleSheet.create({
  card: {
    ...
    backgroundColor: '#fff', borderRadius: 14, borderWidth: 1, borderColor: RIHLA.border, padding: 14, marginBottom: 8,
  },
  ...
  cardName: { fontSize: 14, fontFamily: 'mon-b', color: RIHLA.dark },
  ...
  qtyBtn: { width: 30, height: 30, borderRadius: 15, borderWidth: 1, borderColor: RIHLA.border, alignItems: 'center', justifyContent: 'center' },
  qtyBtnAdd: { backgroundColor: RIHLA.accent, borderColor: RIHLA.accent },
  qtyText: { fontSize: 15, fontFamily: 'mon-b', color: RIHLA.dark, minWidth: 20, textAlign: 'center' },
});
...
const styles = StyleSheet.create({
  ...
  menuCatChip: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, backgroundColor: '#fff', borderWidth: 1, borderColor: RIHLA.border },
  ...
  slotChip: { width: '30%', paddingVertical: 12, borderRadius: 10, borderWidth: 1, borderColor: RIHLA.border, backgroundColor: '#fff', alignItems: 'center' },
  slotChipUnavailable: { backgroundColor: '#F8FAFC' },
  slotChipSelected: { backgroundColor: RIHLA.accent, borderColor: RIHLA.accent },
  slotTime: { fontSize: 14, fontFamily: 'mon-b', color: RIHLA.dark },
  ...
  // Walk-in
  walkInCard: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#fff', borderRadius: 14, borderWidth: 1, borderColor: RIHLA.border, padding: 16 },
  walkInTitle: { fontSize: 14, fontFamily: 'mon-b', color: RIHLA.dark },
