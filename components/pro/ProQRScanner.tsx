...
export default function ProQRScanner({
  ...
  if (!permission.granted) {
    return (
      <View style={styles.centered}>
        <Ionicons name="camera-outline" size={64} color={SAHEL.mutedText} />
          ...
          <View style={styles.controls}>
            ...
            >
              <Ionicons
                ...
                size={26}
                color={torchOn ? SAHEL.highlight : '#FFFFFF'}
              />
              <Text style={[styles.controlLabel, torchOn && { color: SAHEL.highlight }]}>
                Torch
              </Text>
            </Pressable>
...
const styles = StyleSheet.create({
  ...
  cornerTL: {
    ...
    borderTopColor: SAHEL.accent,
    borderLeftColor: SAHEL.accent,
  },
  cornerTR: {
    top: 0,
    right: 0,
  ...
  cornerBL: {
    ...
    borderLeftWidth: CORNER_WIDTH,
    borderBottomColor: SAHEL.accent,
    borderLeftColor: SAHEL.accent,
  },
  cornerBR: {
    bottom: 0,
