    ...
    <View style={[styles.root, { backgroundColor: SAHEL.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: insets.bottom + 120 }}>
        <View style={[styles.heroWrap, { paddingTop: topPad }]}>
          <LinearGradient colors={['#F59E0B', SAHEL.primary]} style={styles.hero}>
        ...
        <View style={styles.statsRow}>
          <View style={styles.statItem}>
            <Ionicons name="pricetag-outline" size={18} color={SAHEL.accent} />
            <Text style={styles.statValue}>{m.price_per_km_dzd} DZD</Text>
            <Text style={styles.statLabel}>Per km</Text>
          </View>
          <View style={styles.statItem}>
            <Ionicons name="airplane-outline" size={18} color={m.airport_transfer ? SAHEL.accent : '#CBD5E1'} />
            <Text style={styles.statValue}>{m.airport_transfer ? 'Available' : 'No'}</Text>
            <Text style={styles.statLabel}>Airport</Text>
          </View>
          <View style={styles.statItem}>
            <Ionicons name="calendar-outline" size={18} color={m.multi_day_hire ? SAHEL.accent : '#CBD5E1'} />
              ...
              <Pressable key={i}
                ...
                <View style={styles.routeInfo}>
                  <View style={styles.routeEndpoints}>
                    ...
                    <View style={styles.routePoint}>
                      <View style={[styles.routeDot, { backgroundColor: SAHEL.accent }]} />
                ...
                {selectedRoute === i && <Ionicons name="checkmark-circle" size={20} color={SAHEL.accent} style={{ position: 'absolute', top: 12, right: 12 }} />}
              </Pressable>
            ))}
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  vehicleCard: { flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: '#fff', borderRadius: 14, borderWidth: 1, borderColor: SAHEL.border, padding: 16 },
  vehicleEmoji: { fontSize: 36 },
  vehicleName: { fontSize: 16, fontFamily: 'mon-b', color: SAHEL.dark },
  ...
  routeList: { gap: 10 },
  routeCard: { backgroundColor: '#fff', borderRadius: 14, borderWidth: 1.5, borderColor: SAHEL.border, padding: 16, position: 'relative' },
  routeSelected: { borderColor: SAHEL.accent, backgroundColor: '#F0FDFA' },
  routeInfo: { flex: 1 },
  routeEndpoints: { gap: 0 },
  routePoint: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  routeDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: SAHEL.primary },
  routeLine: { width: 2, height: 20, backgroundColor: SAHEL.border, marginLeft: 4 },
  routeFrom: { fontSize: 13, fontFamily: 'mon-sb', color: SAHEL.dark },
  routeTo: { fontSize: 13, fontFamily: 'mon-sb', color: SAHEL.accent },
  routePriceWrap: { position: 'absolute', bottom: 14, right: 16 },
  routePrice: { fontSize: 16, fontFamily: 'mon-b', color: SAHEL.primary },
