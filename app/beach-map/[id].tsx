    ...
    <View style={styles.root}>
      ...
      <View style={[styles.header, { paddingTop: topPad }]}>
        ...
        <Pressable style={styles.infoBtn}>
          <Ionicons name="information-circle-outline" size={22} color={SAHEL.primary} />
        </Pressable>
      </View>
...
const styles = StyleSheet.create({
  ...
  headerCenter: { flex: 1 },
  headerTitle: { fontSize: 16, fontFamily: 'mon-b', color: SAHEL.dark },
  ...
  legendTitle: { fontSize: 14, fontFamily: 'mon-b', color: SAHEL.dark },
  legendGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
  ...
  legendLabel: { fontSize: 11, fontFamily: 'mon-b', color: SAHEL.dark },
  legendDesc: { fontSize: 9, fontFamily: 'mon', color: SAHEL.mutedText, textAlign: 'center' },
  infoCard: {
    flexDirection: 'row',
    gap: 10,
