          ...
          <React.Fragment key={i}>
            <View
              style={[
                ...
                active && { backgroundColor: RIHLA.primary, width: 28, borderRadius: 8 },
              ]}
            />
            {i < total - 1 && (
              <View style={[styles.stepLine, done && { backgroundColor: RIHLA.accent }]} />
            )}
          </React.Fragment>
        );
      })}
      ...
      <TouchableOpacity style={styles.mapPickerCard} onPress={onLocationPick} activeOpacity={0.8}>
        {lat && lng ? (
          <View style={styles.mapPicked}>
            <Ionicons name="checkmark-circle" size={48} color={RIHLA.accent} />
          ...
          <View style={styles.mapEmpty}>
            <View style={styles.mapEmptyIcon}>
              <Ionicons name="map-outline" size={32} color={RIHLA.primary} />
            </View>
          ...
          {doc.uri ? (
            ...
            <View style={styles.uploadEmpty}>
              <View style={styles.uploadIconWrap}>
                <Ionicons name="cloud-upload-outline" size={24} color={RIHLA.primary} />
              </View>
  ...
  return (
    <View style={styles.stepContent}>
        ...
        {logoUri ? (
          ...
          <View style={styles.brandEmpty}>
            <View style={styles.brandIconWrap}>
              <Ionicons name="image-outline" size={28} color={RIHLA.primary} />
            </View>
      ...
      <View style={styles.infoCard}>
        <Ionicons name="bulb-outline" size={16} color={RIHLA.accent} />
  ...
  const handleSubmit = async () => {
    ...
    try {
      const data: KycData = {
        ...
        nationalIdDoc: nationalIdUri ? { uri: nationalIdUri, status: 'pending' } : undefined,
        commercialRegDoc: commercialRegUri ? { uri: commercialRegUri, status: 'pending' } : undefined,
        taxInfoDoc: taxInfoUri ? { uri: taxInfoUri, status: 'pending' } : undefined,
        tradeRegisterUri: commercialRegUri ?? undefined,
      };
      await submitKyc(data);
      Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
      showToast('KYC submitted! Documents under review.', 'success');
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 16, fontFamily: 'mon-b', color: RIHLA.dark, marginTop: 1 },
  ...
  // Step content
  stepContent: { gap: 14 },
  stepTitle: { fontSize: 22, fontFamily: 'mon-b', color: RIHLA.dark, letterSpacing: -0.3 },
  ...
  typeCardActive: { borderColor: RIHLA.accent, backgroundColor: '#F0FDFA' },
  ...
  wilayaChipActive: { backgroundColor: RIHLA.primary, borderColor: RIHLA.primary },
  wilayaChipText: { fontSize: 12, fontFamily: 'mon-sb', color: '#475569' },
  wilayaChipTextActive: { color: '#FFFFFF' },
  wilayaSelected: { fontSize: 13, fontFamily: 'mon-sb', color: RIHLA.accent, marginTop: 4 },
  ...
  mapEmptyTitle: { fontSize: 16, fontFamily: 'mon-b', color: RIHLA.dark },
  ...
  mapPickedTitle: { fontSize: 16, fontFamily: 'mon-b', color: RIHLA.dark },
  mapPickedCoords: { fontSize: 13, fontFamily: 'mon', color: RIHLA.mutedText },
  ...
  uploadTitle: { fontSize: 14, fontFamily: 'mon-sb', color: RIHLA.dark },
  ...
  brandLabel: { fontSize: 14, fontFamily: 'mon-sb', color: RIHLA.dark },
  ...
  nextBtn: {
    ...
    backgroundColor: RIHLA.primary, height: 52, borderRadius: 12,
  },
  nextText: { fontSize: 16, fontFamily: 'mon-b', color: '#FFFFFF' },
  submitBtn: { backgroundColor: RIHLA.accent, height: 52, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
