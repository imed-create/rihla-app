  ...
  return (
    <View style={[styles.root, { backgroundColor: RIHLA.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: insets.bottom + 100 }}>
        ...
        {/* ── PRICE BAR ── */}
        <View style={[styles.priceBar, { backgroundColor: colors.card }]}>
          <View>
        ...
        <View style={styles.section}>
          <View style={styles.reviewHeader}>
            ...
            <View>
              ...
              <Text style={[styles.reviewSub, { color: colors.muted }]}>{listing.review_count} verified reviews</Text>
            </View>
          </View>

          {/* Star distribution */}
          <View style={[styles.starDistribution, { backgroundColor: colors.card }]}>
            {[5, 4, 3, 2, 1].map((star) => {
              ...
              return (
                <View key={star} style={styles.starRow}>
                  ...
                  <View style={[styles.starBar, { backgroundColor: colors.bg }]}>
                    <View style={[styles.starBarFill, { width: `${pct}%` }]} />
                  </View>
                  <Text style={[styles.starPct, { color: colors.muted }]}>{pct}%</Text>
                </View>
              );
            })}
          </View>
      ...
      {/* ── STICKY BOTTOM BAR ── */}
      <View style={[styles.bottomBar, { paddingBottom: insets.bottom + 12, backgroundColor: colors.card }]}>
...
const styles = StyleSheet.create({
  ...
  reviewSub: { fontSize: 12, fontFamily: 'mon' },
  starDistribution: { borderRadius: 12, borderWidth: 1, borderColor: RIHLA.border, padding: 12, marginBottom: 10 },
  starRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 4 },
  starLabel: { fontSize: 11, fontFamily: 'mon-b', width: 12, textAlign: 'right' },
  starBar: { flex: 1, height: 5, borderRadius: 3, overflow: 'hidden' },
  starBarFill: { height: '100%', borderRadius: 3, backgroundColor: '#FFD166' },
  starPct: { fontSize: 10, fontFamily: 'mon', width: 26, textAlign: 'right' },
  reviewCard: { borderRadius: 14, borderWidth: 1, borderColor: RIHLA.border, padding: 14, marginBottom: 8 },
  ...
  reviewDate: { fontSize: 10, fontFamily: 'mon', marginLeft: 4 },
  reviewText: { fontSize: 13, fontFamily: 'mon', lineHeight: 20 },
  ...
  bottomBar: {
    ...
    borderTopWidth: 1, borderTopColor: RIHLA.border,
