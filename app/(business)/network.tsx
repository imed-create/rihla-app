...
export default function PartnerNetwork() {
  return (
    <ProTabShell role="business" title="Partner Network" subtitle="Find & collaborate with locals">
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholder}>
          <Ionicons name="git-network-outline" size={48} color="#0a2540" />
          <Text style={styles.title}>Partner Network</Text>
          <Text style={styles.subtitle}>Discover local service partners to collaborate with across Algeria. Coming soon.</Text>
        </View>
      </ScrollView>
    </ProTabShell>
  );
