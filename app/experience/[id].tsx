          ...
          <View style={styles.dateList}>
            {m.departure_dates.map((date, i) => (
              <Pressable key={i}
                ...
                {selectedDate === i && <Ionicons name="checkmark-circle" size={20} color={SAHEL.accent} />}
              </Pressable>
            ))}
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.guestRow}>
            ...
            <View style={styles.guestControls}>
              ...
              <Pressable style={styles.guestBtn} onPress={() => setParticipants(Math.min(m.max_group_size, participants + 1))}><Ionicons name="add" size={18} color={SAHEL.primary} /></Pressable>
            </View>
          </View>
        </View>
          ...
          <View style={styles.checkList}>
            {m.exclusions.map((exc) => (
              <View key={exc} style={styles.checkItem}>
                ...
                <Text style={[styles.checkText, { color: '#64748B' }]}>{exc.charAt(0).toUpperCase() + exc.slice(1)}</Text>
              </View>
            ))}
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  dateList: { gap: 8 },
  dateCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 12, borderWidth: 1.5, borderColor: SAHEL.border, padding: 14 },
  dateSelected: { borderColor: SAHEL.accent, backgroundColor: '#F0FDFA' },
  dateLeft: { flex: 1 },
  dateDay: { fontSize: 13, fontFamily: 'mon-b', color: SAHEL.dark },
  dateFull: { fontSize: 12, fontFamily: 'mon', color: '#64748B', marginTop: 2 },
  datePrice: { fontSize: 14, fontFamily: 'mon-b', color: SAHEL.primary, marginRight: 10 },
  ...
  itineraryCard: { backgroundColor: '#fff', borderRadius: 14, borderWidth: 1, borderColor: SAHEL.border, padding: 16, gap: 6 },
  itineraryDayBadge: { alignSelf: 'flex-start', backgroundColor: SAHEL.primary, paddingHorizontal: 10, paddingVertical: 3, borderRadius: 6 },
  itineraryDayText: { fontSize: 11, fontFamily: 'mon-b', color: '#fff' },
  itineraryTitle: { fontSize: 15, fontFamily: 'mon-b', color: SAHEL.dark, marginTop: 4 },
  itineraryDesc: { fontSize: 13, fontFamily: 'mon', color: '#64748B', lineHeight: 18 },
  highlightList: { gap: 4, marginTop: 6 },
  highlightItem: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  highlightText: { fontSize: 12, fontFamily: 'mon-sb', color: '#475569' },
  checkList: { gap: 8 },
  checkItem: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  checkText: { fontSize: 13, fontFamily: 'mon-sb', color: SAHEL.dark },
  ...
  bookBtn: { backgroundColor: SAHEL.primary, paddingHorizontal: 24, paddingVertical: 16, borderRadius: 14 },
