    ...
    <View style={[styles.root, { backgroundColor: SAHEL.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: insets.bottom + 120 }}>
        <View style={[styles.heroWrap, { paddingTop: topPad }]}>
          <LinearGradient colors={['#10B981', SAHEL.primary]} style={styles.hero}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.specCard}>
            <Ionicons name="compass-outline" size={20} color={SAHEL.accent} />
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statItem}>
            <Ionicons name="cash-outline" size={18} color={SAHEL.accent} />
            <Text style={styles.statValue}>{m.daily_rate_dzd.toLocaleString()}</Text>
            <Text style={styles.statLabel}>DZD/day</Text>
          </View>
          <View style={styles.statItem}>
            <Ionicons name={m.group_tours ? 'people-circle-outline' : 'person-outline'} size={18} color={SAHEL.accent} />
        ...
        <View style={styles.section}>
          ...
          <View style={styles.guestRow}>
            ...
            <View style={styles.guestControls}>
              <Pressable style={styles.guestBtn} onPress={() => setGroupSize(Math.max(1, groupSize - 1))}><Ionicons name="remove" size={18} color={SAHEL.primary} /></Pressable>
              <Text style={styles.guestCount}>{groupSize}</Text>
              <Pressable style={styles.guestBtn} onPress={() => setGroupSize(Math.min(m.max_group_size, groupSize + 1))}><Ionicons name="add" size={18} color={SAHEL.primary} /></Pressable>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  langPill: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, backgroundColor: '#fff', borderWidth: 1, borderColor: SAHEL.border },
  langFlag: { fontSize: 16 },
  langText: { fontSize: 13, fontFamily: 'mon-sb', color: SAHEL.dark },
  specCard: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#fff', borderRadius: 12, borderWidth: 1, borderColor: SAHEL.border, padding: 14 },
  specText: { fontSize: 14, fontFamily: 'mon-sb', color: SAHEL.dark },
  certList: { gap: 8 },
  certItem: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#F0FDFA', borderRadius: 10, padding: 12 },
  certText: { fontSize: 13, fontFamily: 'mon-sb', color: SAHEL.dark },
  ...
  dayTab: { flex: 1, paddingVertical: 8, borderRadius: 8, backgroundColor: '#fff', borderWidth: 1, borderColor: SAHEL.border, alignItems: 'center' },
  dayTabActive: { backgroundColor: SAHEL.primary, borderColor: SAHEL.primary },
  dayTabText: { fontSize: 11, fontFamily: 'mon-sb', color: SAHEL.mutedText },
  slotRow: { flexDirection: 'row', gap: 8, marginTop: 10 },
  noSlots: { fontSize: 13, fontFamily: 'mon', color: '#94A3B8' },
  slotChip: { paddingHorizontal: 18, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: SAHEL.border, backgroundColor: '#fff' },
  slotSelected: { backgroundColor: SAHEL.accent, borderColor: SAHEL.accent },
  slotText: { fontSize: 13, fontFamily: 'mon-sb', color: SAHEL.dark },
