...
export default function PartnerHelp() {
  return (
    <ProTabShell role="partner" title="Help & Support" subtitle="FAQ, contact & tutorials">
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholder}>
          <Ionicons name="help-buoy-outline" size={48} color="#f4a261" />
          <Text style={styles.title}>Help & Support</Text>
          <Text style={styles.subtitle}>Access FAQs, contact support, and view tutorials. Coming soon.</Text>
        </View>
      </ScrollView>
    </ProTabShell>
  );
