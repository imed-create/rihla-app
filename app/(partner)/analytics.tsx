...
export default function PartnerAnalytics() {
  return (
    <ProTabShell role="partner" title="My Analytics" subtitle="Performance metrics & trends">
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholder}>
          <Ionicons name="analytics-outline" size={48} color="#f4a261" />
          <Text style={styles.title}>My Analytics</Text>
          <Text style={styles.subtitle}>Track your performance metrics, earnings trends, and service history. Coming soon.</Text>
        </View>
      </ScrollView>
    </ProTabShell>
  );
