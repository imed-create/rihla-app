...
export default function PayoutSettings() {
  return (
    <ProTabShell role="partner" title="Payout Settings" subtitle="Bank account & payment methods">
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholder}>
          <Ionicons name="wallet-outline" size={48} color="#f4a261" />
          <Text style={styles.title}>Payout Settings</Text>
          <Text style={styles.subtitle}>Manage your bank account details and payment methods. Coming soon.</Text>
        </View>
      </ScrollView>
    </ProTabShell>
  );
