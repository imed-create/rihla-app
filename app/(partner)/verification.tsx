...
export default function Verification() {
  return (
    <ProTabShell role="partner" title="Verification" subtitle="KYC & document uploads">
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholder}>
          <Ionicons name="shield-checkmark-outline" size={48} color="#f4a261" />
          <Text style={styles.title}>Verification</Text>
          <Text style={styles.subtitle}>Complete your KYC and upload required documents. Coming soon.</Text>
        </View>
      </ScrollView>
    </ProTabShell>
  );
