...
export default function EditProfile() {
  return (
    <ProTabShell role="partner" title="Edit Profile" subtitle="Bio, photos & credentials">
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.placeholder}>
          <Ionicons name="create-outline" size={48} color="#f4a261" />
          <Text style={styles.title}>Edit Profile</Text>
          <Text style={styles.subtitle}>Update your bio, photos, and professional credentials. Coming soon.</Text>
        </View>
      </ScrollView>
    </ProTabShell>
  );
